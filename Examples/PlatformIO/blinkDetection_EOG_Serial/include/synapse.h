 ...
 */
    ...
    float apply_EMG_filters1(float input_signal){
      float emg_filter_out = emg_filter1(input_signal);
      float band_stop_out = remove_AC_noise(50,emg_filter_out);
      return band_stop_out;
    }
    float apply_EMG_filters2(float input_signal){
      float emg_filter_out = emg_filter2(input_signal);
      float band_stop_out = remove_AC_noise(50,emg_filter_out);
      return band_stop_out;
    }
